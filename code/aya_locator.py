...
# Set thresholds for the correlation coefficient (template matching)
# template_1 (pages 1-2) needs a higher threshold to avoid matching decorative elements
threshold_1 = 0.4
# template_2 (pages 3-604) uses a lower threshold for the smaller markers
threshold_2 = 0.2685
...
if aya_id - 1 != total_ayas:
    print(f"Error: Missing {total_ayas - (aya_id - 1)} aya matches (threshold_1={threshold_1}, threshold_2={threshold_2})")
else:
